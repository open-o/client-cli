...
public class SchemaValidator extends AbstractSchemaValidate {
     ...
     *             exception
     */
    public SchemaValidator(File schemaFile) throws OpenOCommandInvalidSchema {
        super(schemaFile);
    }

    public SchemaValidator(String schemaFile) throws OpenOCommandInvalidSchema {
        super(schemaFile);
    }

    @Override
    protected void validateSpecificSchema(SchemaType type) throws OpenOCommandInvalidSchema {
