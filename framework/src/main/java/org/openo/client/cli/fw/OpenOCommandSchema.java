 ...
 * recommended to keep the name for schema, in the form of openo-[command-name]-schema.yaml, considered this format as
 ...
 *
 * @OpenOCommandSchema(name="abc-create", schema="openo-abc-create-schema.yaml") public class AbcCreate extends
 *                                        OpenOCommand { ... }
 */
@Retention(RetentionPolicy.RUNTIME)
@Documented
public @interface OpenOCommandSchema {
    /**
     * Command name
     *
     * @return
