 ...
 *
 */
public class OpenOCommandException extends Exception {
     ...
     *            http status code
     */
    public OpenOCommandException(String errorCode, String errorMessage, long httpStatusCode) {
        super();
    ...
    public OpenOCommandException(String errorCode, String errorMessage) {
