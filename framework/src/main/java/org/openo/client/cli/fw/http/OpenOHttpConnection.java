...
public class OpenOHttpConnection {
    ...
    /**
     * OpenOHttpConnection Constructor.
     *
     * @param isSecured
     *            boolean
     * @param debug
    ...
    private String getResponseBody(HttpResponse resp) throws OpenOCommandHttpFailure {
     ...
     *             http failure
     */
    public HttpResult post(final HttpInput input) throws OpenOCommandHttpFailure {
     ...
     *             excpetion
     */
    public HttpResult get(final HttpInput input) throws OpenOCommandHttpFailure {
        input.setMethod("get");
        return this.request(input);
    }
     ...
     *             Exception
     */
    public HttpResult put(final HttpInput input) throws OpenOCommandHttpFailure {
        input.setMethod("put");
        return this.request(input);
    }
     ...
     *             exception
     */
    public HttpResult delete(final HttpInput input) throws OpenOCommandHttpFailure {
     ...
     *             exception
     */
    public HttpResult request(HttpInput input) throws OpenOCommandHttpFailure {
