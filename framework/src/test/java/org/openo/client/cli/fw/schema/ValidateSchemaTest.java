...
public class ValidateSchemaTest {
    ...
    @Test(expected = OpenOCommandInvalidSchema.class)
    public void invalidateTest1() throws OpenOCommandInvalidSchema {
        new SchemaValidator(new File("fdsfds"));
        new SchemaValidator(new File("fdsfds.yaml"));
    }

    @Test(expected = OpenOCommandInvalidSchema.class)
    public void invalidateTest2() throws OpenOCommandInvalidSchema {
        new SchemaValidator(new File("fdsfds"));
    }

    @Test(expected = OpenOCommandInvalidSchema.class)
    public void invalidateTest4() throws OpenOCommandInvalidSchema {
        new SchemaValidator(
                new File(ValidateSchemaTest.class.getClassLoader().getResource("openo.properties").getFile()));
    }

    @Test(expected = OpenOCommandInvalidSchema.class)
    public void invalidateTest5() throws OpenOCommandInvalidSchema {
        new SchemaValidator(new File(
                ValidateSchemaTest.class.getClassLoader().getResource("schema-invalid-file-null.yaml").getFile()));
    }

    @Test
    public void invalidate1Test5() throws OpenOCommandInvalidSchema {
        new SchemaValidator("schema-validate-pass.yaml");
    }

    @Test(expected = ScannerException.class)
    public void invalidateTest3() throws OpenOCommandInvalidSchema {
        new SchemaValidator(
                new File(ValidateSchemaTest.class.getClassLoader().getResource("schema-invalid-file.yaml").getFile()));
    }

    @Test
    public void validateTest() throws OpenOCommandInvalidSchema {
        new SchemaValidator(
    ...
    @Test
    public void schemaValidateInterfaceTest() throws OpenOCommandInvalidSchema {
